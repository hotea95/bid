...
<td class="BOR2" style="width: 60px; height: 60px; overflow: hidden; margin: auto;"><img src="${pageContext.request.contextPath}/${memberDTO.STHPHOTO}"
                     style="width: 100%; height: 100%; object-fit: fill;"></td>
