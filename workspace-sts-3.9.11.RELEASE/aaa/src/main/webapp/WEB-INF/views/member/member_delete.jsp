...
<label for="STHKORNAME">한글 이름</label>
<input type="text" name="STHKORNAME" id="STHKORNAME" value="${memberDTO.STHKORNAME}">
<br>
<label for="STHJUMIN">주민등록번호</label>
<input type="text" name="STHJUMIN" id="STHJUMIN" value="${memberDTO.STHJUMIN}">-<input type="text" name="STHJUMIN" id="STHJUMIN">
