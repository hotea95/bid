...
<body>
    <!-- 검색 입력 필드 및 버튼 코드 추가 -->
    <input type="text" value="이름" readonly="readonly" style="border: none; background-color: transparent;">
    <input type="text" name="keyword3" id="keywordInput3" value="${scri.keyword3}" style="width: 70px;">
    ...
    <script>
        $(function() {
            ...
            $('#searchBtn').click(function() {
                ...
                var url = "/Pou?page=1&searchType=n&keyword3=" + keyword3;
                self.location = url;
            });
            ...
            $(document).on('click', 'input[value="배치"]', function() {
                ...
                if (isDuplicate(no)) {
                    ...
                    // 선택한 사원들의 정보를 배열에 추가
                    selectedEmployees.push({ NO: no, STHKORNAME: sthkorname, STHJUMIN: sthjumin });
         ...
         // 중복 체크 함수
            ...
            function updateAddedEmployees() {
                ...
                for (var i = 0; i < selectedEmployees.length; i++) {
                    ...
                    addedEmployeesTable.append(
                        '<tr>' +
                        '<td>' + employee.NO + '</td>' +
                        '<td>' + employee.STHKORNAME + '</td>' +
                        '<td>' + employee.STHJUMIN + '</td>' +
                        '</tr>'
                    );
