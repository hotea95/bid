...
<input type="text" id="CLINAME" name="CLINAME">
<label for="CLIRE">사업자 등록번호</label>
<input type="text" id="CLIRE" name="CLIRE"><BR><br>
<label for="CLIREP">대표자이름</label>
<input type="text" id="CLIREP" name="CLIREP"> <BR><br>
<label for="CLIBU">업종</label>
<input type="text" id="CLIBU" name="CLIBU">
<label for="CLIONE">업태</label>
<input type="text" id="CLIONE" name="CLIONE"><BR><br>
<label for="CLIADD">사업장 주소</label>
<input type="text" id="CLIADD" name="CLIADD" style="width : 500px;"> <BR><br>
<label for="CLINUM">전화번호</label>
<input type="text" id="CLINUM" name="CLINUM">
<label for="CLIFAX">팩스번호</label>
<input type="text" id="CLIFAX" name="CLIFAX"><BR><br>
<label for="CLIPER">담당자</label>
<input type="text" id="CLIPER" name="CLIPER">
<label for="CLIPHONE">핸드폰 번호</label>
<input type="text" id="CLIPHONE" name="CLIPHONE"> <BR><br>
