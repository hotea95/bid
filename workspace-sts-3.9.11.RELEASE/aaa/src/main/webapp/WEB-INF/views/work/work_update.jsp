	...
	<div>
		...
		<fieldset>
			<label for="WORKNAME">사원명</label> <input type="text" NAME="WORKNAME"
				ID="WORKNAME" value="${update.CARNAME}">
				 <label for="WORKJUMIN">주민등록번호</label> <input
				type="text" NAME="WORKJUMIN" ID="WORKJUMIN" value="${update.CARJUMIN}">-<input
				type="text" NAME="WORKJUMIN2" ID="WORKJUMIN2" value="${update.CARJUMIN2}"> <BR><BR>
			<br> <label for="WORKPRO">프로젝트명</label> <input type="text"
				NAME="WORKPRO" ID="WORKPRO" style="width : 700px;" value="${workDTO.WORKPRO}"><BR><BR> <label for="WORKPLA">근무장소</label>
			<input type="text" NAME="WORKPLA" ID="WORKPLA" style="width : 700px;" value="${workDTO.WORKPLA}"><BR><BR> <label
				for="WORKST">근무시작일</label> <input type="text" NAME="WORKST"
				ID="WORKST" value="${workDTO.WORKST}">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <label for="WORKEND">근무종료일</label> <input
				type="text" NAME="WORKEND" ID="WORKEND" value="${workDTO.WORKEND}"><BR><BR> <label
				for="WORKSAL">매출액</label> <input type="text" NAME="WORKSAL"
				ID="WORKSAL" value="${workDTO.WORKSAL}"><BR><BR> <label for="WORKSCH">결제예정일</label> <input
				type="text" NAME="WORKSCH" ID="WORKSCH" value="${workDTO.WORKSCH}">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <label
				for="WORKDATE">결제일</label> <input type="text" NAME="WORKDATE"
				ID="WORKDATE" value="${workDTO.WORKDATE}"> <BR><BR><BR> <label for="WORKCLI">거래처</label> <select
				NAME="WORKCLI">
